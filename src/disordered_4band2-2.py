...
def make_system(type_4band = 'monolayer'):
    ...
    bulk[kwant.builder.HoppingKind((0,1), B_sub_A,B_sub_D)] = t0
    bulk[kwant.builder.HoppingKind((0,-1), B_sub_A,B_sub_D)] = -t0
    
    bulk[kwant.builder.HoppingKind((0,1), B_sub_B,B_sub_C)] = t0
    bulk[kwant.builder.HoppingKind((0,-1), B_sub_B,B_sub_C)] = -t0
  
    #bulk[kwant.builder.HoppingKind((0,0), B_sub_A,B_sub_A)] = m
    #bulk[kwant.builder.HoppingKind((0,0), B_sub_B,B_sub_B)] = -m
    #bulk[kwant.builder.HoppingKind((0,0), B_sub_C,B_sub_C)] = m
    #bulk[kwant.builder.HoppingKind((0,0), B_sub_D,B_sub_D)] = -m

    bulk[kwant.builder.HoppingKind((0,1), B_sub_A,B_sub_A)] = -t1/2
    bulk[kwant.builder.HoppingKind((0,1), B_sub_C,B_sub_C)] = -t1/2
    bulk[kwant.builder.HoppingKind((1,0), B_sub_A,B_sub_A)] = -t1/2
    bulk[kwant.builder.HoppingKind((1,0), B_sub_C,B_sub_C)] = -t1/2
     
    bulk[kwant.builder.HoppingKind((0,1), B_sub_B,B_sub_B)] = t1/2
    bulk[kwant.builder.HoppingKind((0,1), B_sub_D,B_sub_D)] = t1/2
    bulk[kwant.builder.HoppingKind((1,0), B_sub_B,B_sub_B)] = t1/2
...
for x in [1.00, 0.00]:
    ...
    for d in [0.01, 0.1, 0.3, 0.5, 0.8, 1.0, 1.2, 1.5, 1.8, 2.0, 2.5, 3.0, 4.0, 5.0]:
        ...
        file_name = "4band2-2_DOS_dis_full_"+str(d)+"_m_"+str(x)+"_L_"+str(L)+".dat"
