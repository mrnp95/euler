...
for x in [0.00]:
    ...
    for d in [0.01, 0.1, 0.3, 0.5, 0.8, 1.0, 1.2, 1.5, 1.8, 2.0, 2.5, 3.0]:
        ...
        file_name = "Embedded_Square_DOS_dis_full_"+str(d)+"_mean_"+str(x)+"_L_30.dat"
        ...
        ax_dos.set_title("Disordered Euler Square DOS with KPM (mean = "+str(round(x, 2))+")", y=1.1)
    ...
    fig_dos.savefig(save_fig_to + "Embedded_Square_DOS_dis_full_mean_"+str(x)+".png", bbox_inches = 'tight', dpi='figure')
    fig_cond_xx.savefig(save_fig_to + "Embedded_Square_Sigma_xx_mu_mean_"+str(x)+".png", bbox_inches = 'tight', dpi='figure')
    fig_cond_xy.savefig(save_fig_to + "Embedded_Square_Sigma_xy_mu_mean_"+str(x)+".png", bbox_inches = 'tight', dpi='figure')
