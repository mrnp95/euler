...
for x in [0.00, 0.50]:
    ...
    fig_dos.savefig(save_fig_to + "Haldane_DOS_dis_full_tNNN_"+str(x)+".png", bbox_inches = 'tight', dpi='figure')
    fig_cond_xx.savefig(save_fig_to + "Haldane_Sigma_xx_mu_tNNN_"+str(x)+".png", bbox_inches = 'tight', dpi='figure')
    fig_cond_xy.savefig(save_fig_to + "Haldane_Sigma_xy_mu_tNNN_"+str(x)+".png", bbox_inches = 'tight', dpi='figure')
