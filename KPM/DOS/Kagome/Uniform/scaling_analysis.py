...
for x in [0.00, 0.28, 0.33, 0.50, 1.00]:
    ...
    for L in [100]:
        ...
        ax_cond_xx.set_xlabel(r"Disorder strength $V_0$")
        ...
        fig_cond_xx.savefig(save_fig_to + "Uniform_Scaling_Euler_Sigma_xx_tNNN_"+str(x)+"_miu_"+str(miu)+".png", bbox_inches = 'tight', dpi='figure')
