...
for t in hoppings:
    ...
    fig_C.tight_layout()
    save_fig_to = './'
    fig_C.savefig(save_fig_to + "Marking_mag_imp_Euler_tNNN_"+str(t)+".png", bbox_inches = 'tight', dpi='figure')

    ############
    # SAVING   #
    ############

    file_name = "Euler_mag_imp_Chern_marking_dis_full_"+"_tNNN_"+str(t)+"_L_"+str(L)+".dat"
