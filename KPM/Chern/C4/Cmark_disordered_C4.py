...
for t in means:
    ...
    fig_C.tight_layout()
    save_fig_to = './'
    fig_C.savefig(save_fig_to + "Marking_C4_mean_"+str(t)+".png", bbox_inches = 'tight', dpi='figure')

    ############
    # SAVING   #
    ############

    file_name = "C4_Chern_marking_dis_full_"+"_mean_"+str(t)+"_L_"+str(L)+".dat"
