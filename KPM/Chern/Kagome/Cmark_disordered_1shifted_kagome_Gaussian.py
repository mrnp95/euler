...
miu = -1
disorders = [1.0, 0.01, 0.1, 0.3, 0.5, 0.8, 1.0, 1.2, 1.5, 1.8, 2.0, 2.5, 3.0, 4.0, 5.0]
...
for t in hoppings:
    ...
    fig_C.tight_layout()
    save_fig_to = './'
    fig_C.savefig(save_fig_to + "Marking_1shifted_Euler_tNNN_"+str(t)+".png", bbox_inches = 'tight', dpi='figure')

    ############
    # SAVING   #
    ############

    file_name = "Euler_Chern_1shifted_marking_dis_full_"+"_tNNN_"+str(t)+"_L_"+str(L)+".dat"
