...
hoppings = [0.00, 0.05, 0.25, 0.50, 1.00]
...
for t in hoppings:
    ...
    for d in disorders:
	    ...
	    # Chern markers
            ...
            for tag in tags:
                ...
                C_list = ch.mirror_chern(fsyst, x, y, Mz=None, vectors=vectors, e_F=0.00, kpm_params=dict(num_moments=num_moments), params=None, bounds=None, window=None, return_std=False)
    ...
    fig_C.tight_layout()
    save_fig_to = './'
    fig_C.savefig(save_fig_to + "Marking_SC_Euler_N3_"+str(t)+".png", bbox_inches = 'tight', dpi='figure')
    ...
    save_fig_to = './'
    fig_Cabs.savefig(save_fig_to + "Abs_Marking_SC_Euler_N3_"+str(t)+".png", bbox_inches = 'tight', dpi='figure')
    ...
    save_fig_to = './'
    fig_Cstd.savefig(save_fig_to + "Stdev_Marking_SC_Euler_N3_"+str(t)+".png", bbox_inches = 'tight', dpi='figure')

    ############
    # SAVING   #
    ############

    file_name = "SC_Euler_N3_Chern_marking_dis_full_"+"_tNNNN_"+str(t)+"_L_"+str(L)+".dat"
